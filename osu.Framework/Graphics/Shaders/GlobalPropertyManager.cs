...
namespace osu.Framework.Graphics.Shaders
{
    internal static class GlobalPropertyManager
    {
        ...
        static GlobalPropertyManager()
        {
            ...
            global_properties[(int)GlobalProperty.ProjMatrix] = new UniformMapping<Matrix4X4<float>>("g_ProjMatrix");
            global_properties[(int)GlobalProperty.MaskingRect] = new UniformMapping<Vector4>("g_MaskingRect");
            global_properties[(int)GlobalProperty.ToMaskingSpace] = new UniformMapping<Matrix3X3<float>>("g_ToMaskingSpace");
