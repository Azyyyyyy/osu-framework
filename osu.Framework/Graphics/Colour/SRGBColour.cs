...
namespace osu.Framework.Graphics.Colour
{
    ...
    /// This struct implicitly converts to sRGB space Colour4 values (i.e. it can be assigned and implicitly cast)
    /// to sRGB Colour4.
    /// </summary>
    public struct SRGBColour : IEquatable<SRGBColour>
    {
        public Colour4 Linear;
        ...
        public static SRGBColour FromVector(Vector4 v) => new SRGBColour { Linear = new Colour4(v.X, v.Y, v.Z, v.W) };
        ...
        public void MultiplyAlpha(float alpha) => Linear = Linear.MultiplyAlpha(alpha);
