...
namespace osu.Framework.IO.Stores
{
    public class FontStore : TextureStore, ITexturedGlyphLookupStore
    {
        ...
        public FontStore(IResourceStore<TextureUpload> store = null, float scaleAdjust = 100, GLEnum minFilterMode = GLEnum.Linear)
            : this(store, scaleAdjust, true, filteringMode: minFilterMode)
        {
        }

        internal FontStore(IResourceStore<TextureUpload> store = null, float scaleAdjust = 100, bool useAtlas = false, Storage cacheStorage = null, GLEnum filteringMode = GLEnum.Linear)
